...
def eva(valores,valores_2,tasa):    # Aquí va tu método m
    ...
    lt_1 = valores[2]  # Tiempo de proveedor a planta
    semanas_cxp_1 = valores[3]  # Semanas de crédito proveedor
    adu_1 = valores[4]  # Consumo semanal del material 
    inv_prom_1 = valores[5]  # Factor tiempo de tránsito
    taf_gz_1 = valores[6] #Tarifa de gestion cargo
    tarifa_alm_1 = valores[7]  # Tarifa de almacenamiento
    costo_transporte_1 = valores[8] # Costo de transporte 
    ...
    lt = valores_2[2] # Tiempo de proveedor a planta
    semanas_cxp = valores_2[3]  # Semanas de crédito proveedor
    adu = valores_2[4] # Consumo semanal del material 
    inv_prom = valores_2[5]  # Factor tiempo de tránsito
    taf_gz = valores_2[6] #Tarifa de gestion cargo
    tarifa_alm = valores_2[7]  # Tarifa de almacenamiento
    costo_transporte = vvalores_2[8] # Costo de transporte 
    precio_compra = valores_2[9]  # Precio de compra
    ...
    capital_invertido = ((diferencial + inv_prom_sem) * (adu)) * (precio_compra)  # Capital invertido: Cálculo basado en diferenciales, inventario semanal y precio de compra
...
def uodi(valores,valores_2,tasa):
    ...
    costo_compra_1 = precio_compra_1 * cantidad_1  # Costo de compra: Precio de compra por cantidad
    costo_total_1 = costo_maninv_1 + costo_compra_1 + costo_cap_1 + costo_transporte_1 + costo_nacionalizacion_1 # Costo total: Suma de varios costos
    costo_ebitda_1 = costo_maninv_1 + costo_compra_1 + costo_transporte_1 + costo_nacionalizacion_1 # Costo EBITDA: Suma de costos relevantes
    costo_unitario_1 = costo_total_1 / cantidad_1  # Costo unitario: Costo total dividido por cantidad
    capital_invertido_1 = ((diferencial_1 + inv_prom_sem_1) * (adu_1)) * (precio_compra_1)  # Capital invertido: Cálculo basado en diferenciales, inventario semanal y precio de compra
    ...
    costo_compra = precio_compra * cantidad  # Costo de compra: Precio de compra por cantidad
    costo_total = costo_maninv + costo_compra + costo_cap + costo_transporte + costo_nacionalizacion # Costo total: Suma de varios costos
    costo_ebitda = costo_maninv + costo_compra + costo_transporte + costo_nacionalizacion# Costo EBITDA: Suma de costos relevantes
    costo_unitario = costo_total / cantidad  # Costo unitario: Costo total dividido por cantidad
    capital_invertido = ((diferencial + inv_prom_sem) * (adu)) * (precio_compra)  # Capital invertido: Cálculo basado en diferenciales, inventario semanal y precio de compra
