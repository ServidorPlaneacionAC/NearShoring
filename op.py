...
def main():
    ...
    nombres=(
        ...
        "Frecuencia: Tiempo estimaddo para recalcular o recibir el próximo envío",
        "lead time entrega en planta: tiempo estimado para entregar en planta (si se consideran varias plantas, tomar el tiempo mayor)",
        "condición de pago: tiempo en semanas estimado para pagar alproveedor el pedido actual",
        "Cantidad mínima a pedir: Cantidad dada en unidad de medida determinada por el negociador",
        ...
        "Factor lead time: De 0 a 1 qué tan volátil es el lead time, siendo 0 muy seguro y 1 completamente variable",
        "Factor variación: De 0 a 1 qué tan volátil es el consumo, siendo 0 muy seguro y 1 completamente variable",
        "Unidades por estiba: Cantidad dada en unidad de medida determinada por el negociador",
