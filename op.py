...
def m(valores,valores_2):
    ...
    status = prob.solve()
#     return (p_1.value())
    return f"ingreso bueno {p_1.value() ,value(costo_maninv),value(costo_nacionalizacion),value(costo_transportegz_planta),value(costo_ebitda_1),value(costo_ebitda)}"
