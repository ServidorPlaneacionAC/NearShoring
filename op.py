...
with col1:
    ...
    valores = []
    for i in range(14):
        valores.append(st.number_input(f"{nombres[i]}   ", step=0.1, min_value=0, max_value=100000))
...
with col2:
    ...
    valores_2 = []
    for i in range(15):
        valores_2.append(st.number_input(f"{nombres[i]}", step=0.01, min_value=0, max_value=100000))
