...
def m(valores,valores_2):
    ...
    costo_total_1=costo_maninv_1+costo_compra_1+costo_cap_1+costo_nacionalizacion_1+costo_transportegz-planta_1
    ...
    costo_transportegz-planta=200*cantidad
    ...
    costo_total=costo_maninv+costo_compra+costo_cap+costo_nacionalizacion+costo_transportegz-planta
