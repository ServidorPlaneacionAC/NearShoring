...
def m(valores,valores_2):
    ...
    status = prob.solve()
#     return (p_1.value())
    return f"ingreso bueno {p_1.value() ,value(uodi),value(diferencial_ct),value(capital_invertido_1),value(capital_invertido),value(diferencial_1),value(inv_prom_sem_1)}"
